                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="<c:url value='/organization/edit' />">
										...
										<a href="<c:url value='/organization/delete?ORGANIZATION_SEQ=${paramMap.ORGANIZATION_SEQ}' />">
											<button type ="button" class = "btn btn-default"> delete </button>
										</a>
										<a href="<c:url value='/organization/edit?ORGANIZATION_SEQ=${paramMap.ORGANIZATION_SEQ}' />">
