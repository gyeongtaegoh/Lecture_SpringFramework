                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="<c:url value='/organization/insert' />">
										<div class="form-group">
										    <label for="disabledSelect">ORGANIZATION_SEQ Disabled input </label>
										    <input class="form-control" type="text" name="ORGANIZATION_SEQ" value="${resultMap.ORGANIZATION_SEQ}" readonly>
                                        ...
                                        <div class="form-group">
										    ...
										    <input class="form-control" type="text" name="PARENT_ORGANIZATION_SEQ" value="22222-2222-UUID222222222222" >
